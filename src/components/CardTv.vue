...
export default {
    ...
    methods: {
        getTvCast() {
            axios
                .get(`https://api.themoviedb.org/3/tv/${this.itemid}/credits?${store.apiKey}`)
                .then(res => {
...
<template>
    ...
    <div class="card" @mouseenter="resetTvCast">
        <img :src="`${store.UrlImage}${item.poster_path}`" :alt=item.name onerror="this.src='/images/notfound.webp';">
        ...
        <div class="cont-text">
            ...
            <div class="cast title" @click="getTvCast()">
